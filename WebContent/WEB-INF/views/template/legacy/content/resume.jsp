    			...
    			<div class="col-md-3">
				    <nav id="navi">
					    <ul>
					      ...
					      <li><a href="#page-5">Licenses</a></li>
					    </ul>
					  </nav>
					</div>
					<div class="col-md-9">
					  ...
					  <div id="page-4" class= "page three">
					  	...
					  	<div class="row progress-circle mb-5">
						      ...
						      <div class="bg-white rounded-lg shadow p-4">
						        <h2 class="h5 font-weight-bold text-center mb-4">JAVA(1.7/1.8)</h2>
						        <!-- Progress bar 1 -->
					  		...
					  		<div class="col-lg-4 mb-4">
						      <div class="bg-white rounded-lg shadow p-4">
						        <h2 class="h5 font-weight-bold text-center mb-4">Spring MVC</h2>
						        <!-- Progress bar 1 -->
						        <div class="progress mx-auto" data-value='70'>
						          <span class="progress-left">
                        			<span class="progress-bar border-primary"></span>
					  		...
					  		<div class="col-lg-4 mb-4">
						      <div class="bg-white rounded-lg shadow p-4">
						        <h2 class="h5 font-weight-bold text-center mb-4">Javascript&Jquery</h2>
						        <!-- Progress bar 1 -->
    					...
    					<h2>Sub Skills</h2>
					  	<div class="row">
					  		...
					  		<div class="col-md-4 animate-box">
								<div class="progress-wrap ftco-animate">
									<h3 style="font-weight:bold">MariaDB&Mysql</h3>
								</div>
							</div>
					  		<div class="col-md-4 animate-box">
								<div class="progress-wrap ftco-animate">
					  		...
					  		<div class="col-md-4 animate-box">
								<div class="progress-wrap ftco-animate">
									<h3 style="font-weight:bold">Javascript libraries</h3>
								</div>
							</div>
					  		<div class="col-md-4 animate-box">
								<div class="progress-wrap ftco-animate">
					  		...
					  		<div class="col-md-4 animate-box">
								<div class="progress-wrap ftco-animate">
									<h3 style="font-weight:bold">IIS&IIS FTP server</h3>
								</div>
							</div>
					  		<div class="col-md-4 animate-box">
								<div class="progress-wrap ftco-animate">
									<h3 style="font-weight:bold">Filezila FTP server</h3>
								</div>
							</div>
					  		<div class="col-md-4 animate-box">
								<div class="progress-wrap ftco-animate">
